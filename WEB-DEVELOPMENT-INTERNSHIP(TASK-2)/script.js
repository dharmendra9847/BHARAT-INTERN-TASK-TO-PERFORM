...
/* ----- Message-Received ----- */
const scriptURL =
  "https://script.google.com/macros/s/AKfycbwcfd7ltw7LrG5YCW8NA1O5Buoo2SocORx96RUZfkhS5zGym_AfPs3BLIn8VkmOAkDUyw/exec";
...
form.addEventListener("submit", (e) => {
  ...
  fetch(scriptURL, { method: "POST", body: new FormData(form) })
    .then((response) => {
      messageReceived.innerHTML = "Message sent successfully ✅";
      setTimeout(() => {
